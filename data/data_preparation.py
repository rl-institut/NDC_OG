...
SCENARIOS_DESCRIPTIONS = {
    BAU_SCENARIO:
        [html.H4('What it shows:'), '''The Business-as-Usual (BaU) scenario quantifies the number of new technology-specific electrifications (Grid Extension, Mini-Grids or Solar-Home Systems) until 2030 by projecting current business-as-usual growth rates into the future. This scenario does not assume that the universal access goal is achieved. In this scenario, electricity access is defined as the equivalent of ''', html.A(children="ESMAP’s TIER 2", href='https://www.esmap.org/node/55526'), ''' where Solar-Home-Systems find application, and TIER 3 where Mini-Grids are deployed or Grid Extension takes place.
How it is obtained: Regional projections of electrification rates and technologies are mapped to the country-level and modelled until 2030. The BaU scenario is based on the "New Policies" Scenario of the ''', html.A(children="International Energy Agency’s World Energy Outlook 2018", href='https://www.iea.org/weo2018/scenarios/'), '''. '''],
    SE4ALL_SCENARIO:
        [html.H4('What it shows:'), '''The Sustainable-Energy-For-All (SE4ALL) scenario estimates the number of new technology-specific electrifications (Grid Extension, Mini-Grids or Solar-Home Systems) necessary to achieve the universal access goal until 2030. These estimations account for expected population growth rates. In this scenario, electricity access is defined as the equivalent of ''', html.A(children="ESMAP’s TIER 2", href='https://www.esmap.org/node/55526'), ''' where Solar-Home-Systems find application, and TIER 3 where Mini-Grids are deployed or Grid Extension takes place.
How it is obtained: Existing datasets providing night lights, population densities and transmission grids are combined to estimate the number of people lacking access to electricity. Appropriate electrification options are determined based on the remoteness and density of neglected populations. In this way the model estimates the share of people that remain to be electrified by either Grid Extension, Mini-Grid deployment or Solar-Home-System adoption until 2030. 
